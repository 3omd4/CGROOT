...
// note:         N/A
void sigmoid_Funct(double &input) { input = 1.0 / (1.0 + exp(-input)); }
...
// side effect:  input is set with result value
// note:         N/A
void reLU_Funct(double &input) { input = (input > 0.0) ? input : 0.0; }
...
// side effect:  N/A
// note:         N/A
double d_reLU_Funct(double input) { return (input > 0) ? 1.0 : 0.0; }
...
// side effect:  N/A
// note:         N/A
double d_sigmoid_Funct(double input) { return input * (1.0 - input); }
...
// side effect:  N/A
// note:         N/A
double d_tanh_Funct(double input) { return 1.0 - input * input; }
